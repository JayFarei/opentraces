...
FIELD_SPECS: list[FieldSpec] = [
    ...
    FieldSpec("patches", "Trace's output patches (one per Edit/Write tool call)", "parser", "has_edits", ["domain", "rl"]),
    FieldSpec("patches[].patch_id", "Content-addressed patch id (= trace_patch_id)", "parser", "has_edits", ["domain", "rl"]),
    FieldSpec("patches[].file_path", "Path at creation time", "parser", "has_edits", ["domain", "rl"]),
