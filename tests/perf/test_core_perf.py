...
from tests.perf.harness.measure import measure_command_factory, measure_python_factory, write_artifact
...
def _all_scenarios() -> list:
    return load_scenarios("core", lane="nightly")
