...
from tests.perf.harness.measure import measure_command_factory, write_artifact
...
from tests.perf.harness.subprocess import build_command_plan


@pytest.mark.perf
@pytest.mark.parametrize("scenario", load_scenarios("cli", lane="nightly"), ids=lambda s: s.name)
def test_cli_perf(
    scenario,
