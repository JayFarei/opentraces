...
class TestOnStopHook:
    def test_appends_valid_hook_line(self, tmp_path, monkeypatch):
        from opentraces.agents.claude_code.hooks.on_stop import main
    ...
    def test_git_failure_still_writes_line(self, tmp_path, monkeypatch):
        ...
        from opentraces.agents.claude_code.hooks import on_stop
...
class TestOnCompactHook:
    def test_appends_valid_hook_line(self, tmp_path, monkeypatch):
        from opentraces.agents.claude_code.hooks.on_compact import main
