...
{"\n"}  ],
{"\n"}  <span className="schema-key">&quot;outcome&quot;</span>: {"{"} <span className="schema-key">&quot;success&quot;</span>: <span className="schema-type">true</span>, <span className="schema-key">&quot;committed&quot;</span>: <span className="schema-type">true</span>, <span className="schema-key">&quot;patch&quot;</span>: <span className="schema-str">&quot;...&quot;</span>, <span className="schema-key">&quot;terminal_state&quot;</span>: <span className="schema-type">null</span>, <span className="schema-key">&quot;reward&quot;</span>: <span className="schema-type">null</span>, <span className="schema-key">&quot;reward_source&quot;</span>: <span className="schema-type">null</span> {"}"},
{"\n"}  <span className="schema-key">&quot;intent&quot;</span>: {"{"} <span className="schema-key">&quot;title&quot;</span>: <span className="schema-str">&quot;Fix failing parser test&quot;</span>, <span className="schema-key">&quot;source&quot;</span>: <span className="schema-str">&quot;llm_hook&quot;</span>, <span className="schema-key">&quot;model&quot;</span>: <span className="schema-str">&quot;anthropic/claude-sonnet-4&quot;</span> {"}"},
...
{"\n"}  <span className="schema-key">&quot;security&quot;</span>: {"{"} <span className="schema-key">&quot;scanned&quot;</span>: <span className="schema-type">true</span> {"}"},
