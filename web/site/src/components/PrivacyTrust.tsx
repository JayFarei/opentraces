...
const modes = [
  {
    ...
    label: "auto-ready",
    color: "var(--accent)",
    desc: "Safe traces can land in Ready automatically after scanning and redaction. You still decide when to commit and push.",
    terminal: [
      { p: "~$", c: "opentraces init", f: "--review-policy", s: "auto-ready" },
      { di: " --push-policy manual" },
      { gap: true },
      { ok: "\u2713", di: " review policy: auto-ready" },
      { ok: "\u2713", di: " installed Claude Code hook" },
      { gap: true },
      { p: "~$", c: "opentraces commit", f: "--all" },
      { di: "6 ready traces bundled for push" },
      { gap: true },
      { p: "~$", c: "opentraces push" },
      { di: "auto-redacted ", n: "4", diEnd: " secrets (JWT, API key, email, DB URL)" },
      { ok: "\u2713", di: " pushed 6 committed sessions \u2192 ", s: "jayfarei/opentraces" },
    ],
  },
  {
    id: "review",
    ...
    color: "var(--text)",
    desc: "Sessions are staged locally. You review in the browser inbox or TUI, approve or reject each one, then commit and push the ready set.",
    terminal: [
      { p: "~$", c: "opentraces init" },
      { gap: true },
      ...
      { di: "  approve / redact / reject in the inbox UI" },
      { gap: true },
      { p: "~$", c: "opentraces commit", f: "--all" },
      { di: "6 ready traces bundled" },
      { gap: true },
      { p: "~$", c: "opentraces push" },
      { di: "auto-redacted ", n: "3", diEnd: " secrets" },
      { ok: "\u2713", di: " pushed 6 committed sessions" },
    ],
  },
];
