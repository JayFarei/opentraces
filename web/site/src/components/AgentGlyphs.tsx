// Shared agent glyphs (Claude Code, Codex, Pi). Used by the hero Copy Prompt
// button deck and the agent composer status line. All ride currentColor.
...
export function CodexGlyph({ className }: GlyphProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" aria-hidden="true">
...
export function PiGlyph({ className }: GlyphProps) {
  return (
    <svg className={className} viewBox="0 0 800 800" fill="currentColor" aria-hidden="true">
...
export const AGENT_GLYPHS = [ClaudeGlyph, CodexGlyph, PiGlyph];
