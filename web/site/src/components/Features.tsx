...
const features = [
  ...
  { color: "var(--c-user)", title: "trace discovery", cmd: "opentraces trace query --skill", desc: "query, get, map, and slice expose deterministic packets over a local lexical + concept index (BM25 plus a bounded concept join, not embeddings), without loading full transcripts." },
  ...
  { color: "var(--c-exec)", title: "context tree", cmd: "opentraces ctx <trace>", desc: "ctx reconstructs what the agent saw at a step and produces resume packets." },
