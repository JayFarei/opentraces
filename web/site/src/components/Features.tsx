...
const features = [
  ...
  { color: "var(--c-user)", title: "trace discovery", cmd: "opentraces trace skills", desc: "query, skills, map, slice, and get expose deterministic packets over a local lexical + concept index (BM25 plus a bounded concept join, not embeddings), without loading full transcripts." },
